...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    Page<Ticket> findAllByUsuarioAsignadoId(Pageable pageable, Long id);
    Page<Ticket> findAllByUsuarioAsignadoIdAndDepartamentoNombre(Pageable pageable, Long id, String departamentoNombre);
