...
//   getVencimiento,
// } from "../../utils/utils"; 
// import { FaCheckCircle as FaCheckCircleSolid, FaLock, FaSpinner as FaSpinnerSolid, FaTrash } from "react-icons/fa"; // Using alias to avoid conflict if any
// import { BiMessageAltDetail } from "react-icons/bi";
// import UserInfo from "../Users/UserInfo";
// import { IoMdAdd } from "react-icons/io";
// import { useNavigate } from "react-router-dom";
// import { deleteTicket, updateTicketStatus } from "../../services/TicketService"; // Import your service
...
//   // Function to handle completing the ticket
...
//     // Instead of directly completing, show the confirmation dialog
...
//     try {
//       if (ticket.estado==2) {
//         await updateTicketStatus(ticket.id, 3); // Proceso
//       }
//       else await updateTicketStatus(ticket.id, 2); // Completado
...
//                   disabled={isClosing || ticket.estadoNombre === "COMPLETADOS"}
...
//             {/* Ensure PRIORITYNAMES and ticket.prioridad are valid */}
...
//                 TICKET_TYPE && ticket?.estado ? TICKET_TYPE[ticket.estado] : 'bg-gray-400' // Defensive check
//               )}
//             />
...
//             {/* IMPORTANT: Adjust "En Proceso" to the exact status string used in your system for 'in-progress' tickets. */}
//             {ticket?.estadoNombre === "EN-PROCESO" && (
//               <button
//                 onClick={handleCompleteTicket}
//                 disabled={isCompleting}
//                 className="w-full flex gap-2 items-center justify-center px-4 py-2 text-sm text-white font-medium bg-green-500 hover:bg-green-600 rounded-md transition-colors disabled:opacity-50"
//               >
//                 {isCompleting ? (
//                   <FaSpinnerSolid className="animate-spin text-lg" />
//                 ) : (
//                   <FaCheckCircleSolid className="text-lg" />
//                 )}
//                 <span>{isCompleting ? "COMPLETANDO..." : "MARCAR COMO COMPLETADO"}</span>
//               </button>
//             )}
//           </div>
//         </div>
...
//         </div>
//       )}
//       <div ref={overlayRef} className=""></div>
...
const Card = ({ ticket, onTicketStatusChange, onTicketDelete }) => {
  ...
  // Función para manejar cerrar el ticket
  ...
  //     toast.success(`Ticket "${ticket.tema}" cerrado correctamente.`);
  //     if (onTicketStatusChange) {
  //       onTicketStatusChange();
  //     }
  //   } catch (error) {
  ...
  return (
    <>
      <div className="w-full h-fit bg-white shadow-md p-4 rounded-xl relative">
